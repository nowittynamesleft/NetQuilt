...
#save_rwr_matrices(tax_ids, add=True)
save_rwr_matrices(tax_ids, network_folder=net_dir, add=False)
...
save_block_matrices(alpha, tax_ids, block_matrix_folder='./block_matrix_rand_init_test_files_no_add/', rand_init=True, ones_init=False, add=False)
print('Done.')
